...
/**
 * WebSocket {@link org.glassfish.grizzly.filterchain.Filter} implementation, which supposed to be placed into a {@link org.glassfish.grizzly.filterchain.FilterChain} right after HTTP
 * Filter: {@link org.glassfish.grizzly.http.HttpServerFilter}, {@link org.glassfish.grizzly.http.HttpClientFilter}; depending whether it's server or client side. The
...
class WebSocketFilter extends BaseFilter {
    ...
    /**
     * Method handles Grizzly {@link org.glassfish.grizzly.Connection} connect phase. Check if the {@link org.glassfish.grizzly.Connection} is a client-side {@link
     ...
     * connection - pass processing to the next {@link org.glassfish.grizzly.filterchain.Filter} in a chain.
     *
    ...
    /**
     * Method handles Grizzly {@link org.glassfish.grizzly.Connection} close phase. Check if the {@link org.glassfish.grizzly.Connection} is a {@link org.glassfish.tyrus.websockets.WebSocket}, if
     * yes - tries to close the websocket gracefully (sending close frame) and calls {@link
     * org.glassfish.tyrus.websockets.WebSocket#onClose(org.glassfish.tyrus.websockets.draft06.ClosingFrame)}. If the Grizzly {@link org.glassfish.grizzly.Connection} is not websocket - passes processing to the next
     * filter in the chain.
     *
     * @param ctx {@link org.glassfish.grizzly.filterchain.FilterChainContext}
     * @return {@link org.glassfish.grizzly.filterchain.NextAction} instruction for {@link org.glassfish.grizzly.filterchain.FilterChain}, how it should continue the execution
    ...
    /**
     * Handle Grizzly {@link org.glassfish.grizzly.Connection} read phase. If the {@link org.glassfish.grizzly.Connection} has associated {@link org.glassfish.tyrus.websockets.WebSocket} object
     ...
     * pass processing to appropriate {@link org.glassfish.tyrus.websockets.WebSocket}: {@link org.glassfish.tyrus.websockets.WebSocketApplication} for server- and client- side
     * connections.
     *
     * @param ctx {@link org.glassfish.grizzly.filterchain.FilterChainContext}
     * @return {@link org.glassfish.grizzly.filterchain.NextAction} instruction for {@link org.glassfish.grizzly.filterchain.FilterChain}, how it should continue the execution
    ...
    /**
     * Handle Grizzly {@link org.glassfish.grizzly.Connection} write phase. If the {@link org.glassfish.grizzly.Connection} has associated {@link org.glassfish.tyrus.websockets.WebSocket} object
     * (websocket connection), we assume that message is websocket {@link org.glassfish.tyrus.websockets.DataFrame} and serialize it into a {@link
