...
public class LauncherTest {
    ...
    public void should_use_application_name_as_root_context() throws Exception {
        ...
        assertThat(get("http://localhost:8051/test/s1"), is("servlet1\n"));
    }
    ...
    public void should_register_all_resources_as_api() throws Exception {
        ...
        assertThat(get("http://localhost:8051/test/api/resource1/message"), is("message"));
    }
    ...
    public void should_inject_service_to_resource_and_servlets() throws Exception {
        ...
        assertThat(get("http://localhost:8051/test/s1"), is("injected"));
        assertThat(get("http://localhost:8051/test/api/resource1/message"), is("injected"));
    }
    ...
    public void should_override_inject_service_to_resource_and_servlets() throws Exception {
        ...
        assertThat(get("http://localhost:8051/test/s1"), is("injection override"));
        assertThat(get("http://localhost:8051/test/api/resource1/message"), is("injection override"));
    }

    @Test
    public void should_auto_scan_application_modules() throws Exception {
        server = new Launcher(config).launch(false, "auto-scan");
        assertThat(get("http://localhost:8051/auto-scan/s1"), is("auto-scan"));
        assertThat(get("http://localhost:8051/auto-scan/api/resource1/message"), is("auto-scan"));
    }
